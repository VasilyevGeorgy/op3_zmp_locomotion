...
void op3_zmp_quasistatic::initializeROSSim(){
//Right leg
  r_hip_y_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_hip_yaw_position/command",100);
  r_hip_r_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_hip_roll_position/command",100);
  r_hip_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_hip_pitch_position/command",100);
  r_kn_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_knee_position/command",100);
  r_an_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_ank_pitch_position/command",100);
  r_an_r_pub = node.advertise<std_msgs::Float64>("robotis_op3/r_ank_roll_position/command",100);
//Left leg
  l_hip_y_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_hip_yaw_position/command",100);
  l_hip_r_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_hip_roll_position/command",100);
  l_hip_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_hip_pitch_position/command",100);
  l_kn_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_knee_position/command",100);
  l_an_p_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_ank_pitch_position/command",100);
  l_an_r_pub = node.advertise<std_msgs::Float64>("robotis_op3/l_ank_roll_position/command",100);
...
void op3_zmp_quasistatic::initializeROSMan(){
  ...
  //this->setLegsModule("directControl");
...
void op3_zmp_quasistatic::managerJointPos(){
  present_joint_states_sub = node.subscribe("/robotis/present_joint_states",1000, &op3_zmp_quasistatic::presStateCallback, this);
...
void op3_zmp_quasistatic::presStateCallback(const sensor_msgs::JointState::ConstPtr &jnt_data)
{
...
void op3_zmp_quasistatic::perFrameLocomotion(unsigned long int num_of_frame){
  ...
  if(ros::ok())
    this->publishMessageROSMan(rleg_joint_angles.at(num_of_frame), lleg_joint_angles.at(num_of_frame));
...
void op3_zmp_quasistatic::setLegsModule(std::string moduleName){
...
void op3_zmp_quasistatic::setModule(std::string moduleName){
